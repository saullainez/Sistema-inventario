create procedure crear_activo(IN nombre varchar(100), IN descripcion varchar(250), IN tipo varchar(50))
  begin
    ...
    insert into inventario_activos (ActivoId, Cantidad, created_at, updated_at) values (@id, 0, now(), now());

create procedure crear_presentacion(IN presentId int, IN actId int, IN productId int)
  begin
    ...
    insert into inventarios (PresentacionId, Cantidad, created_at, updated_at) values (presentId, 0, now(), now());

DELIMITER $$
CREATE DEFINER=`root`@`localhost` PROCEDURE `actualizar_mov_act`(IN actId int, IN fech date, IN descrip text, IN cant int, IN mont double,

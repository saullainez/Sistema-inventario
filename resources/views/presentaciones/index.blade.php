...
<div class="row wow fadeIn">
    ...
    <div class="card" style="width:100%;">
        <div class="container">
            <div class="card-header row">
                <div class="col-12 col-sm-12 col-md-3 col-lg-6">
                    <h5 style="position: relative; top: 1rem;">Administrar productos finales</h5>
                </div> 
        ...
        <div class="card-body">
            <h4 class="card-title text-center">Listado de productos finales</h4>
            <div class="px-4">

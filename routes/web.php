...
Route::post('/agregarrol', 'UserController@agregarRolUsuario');
...
Route::post('/agregarpermiso', 'RoleController@agregarPermisoRol');
...
Route::get('/obtenerconsumibles', 'ActivoController@obtenerConsumibles');
